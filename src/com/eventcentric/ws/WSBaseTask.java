...
public abstract class WSBaseTask<T> extends BaseTask<Void, Void, T>{
	...
	protected static String HOST = "www.shizzlr.com";
	protected static String URL = "http://" + HOST + "/ShizzlrWS.asmx";
...
//	protected static String URL = "http://" + HOST + "/ShizzlrWS.aspx";
    ...
    public WSBaseTask(TaskContext taskContext) {
	    super(taskContext);
